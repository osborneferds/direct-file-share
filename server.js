...
app.post('/upload', (req, res) => {
    upload(req, res, function (err) {
        // If any error occurred during upload (file size, file type, etc.), handle it here.
        if (err) {
        ...
        // Send a relative URL to the client. The client will construct the full URL.
        const relativeUrl = `/download/${req.file.filename}`;
        res.json({ downloadUrl: relativeUrl });
    });
});
...
// This should be the last route. It serves the main HTML file for any non-API GET request.
app.get('*', (req, res) => {
